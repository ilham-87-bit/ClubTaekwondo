/**
 * This script has been changed by TBR.
 *
 * When upgrading make sure the following method still exists:
 *
 * setDataAtCellNoRenderNoValidateNoApply
 */
/**
 * Handsontable 0.9.6
       ...
       selection.refreshBorders();
        ...
        editproxy = { //this public assignment is only temporary
            ...
            setCopyableText: function () {
                ...
                instance.copyPaste.copyable(datamap.getText({row: startRow, col: startCol}, {
                    row: finalEndRow,
                    col: finalEndCol
                }));
        ...
        /**
         * TBR --> added this for performance reasons!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
         */
        this.setDataAtCellNoRenderNoValidateNoApply = function (row, col, value, source) {
            var input = setDataInputToArray(row, col, value)
                , i
                , ilen
                , changes = []
            ...
            for (i = 0, ilen = input.length; i < ilen; i++) {
                ...
                // added this
                //register the change in the datamap:
                datamap.set(changes[i][0], changes[i][1], changes[i][3]);
            }
        ...
        this.populateFromArray = function (row, col, input, endRow, endCol, source, method) {
            ...
            return grid.populateFromArray({row: row, col: col}, input, typeof endRow === 'number' ? {
                row: endRow,
                col: endCol
            } : null, source, method);
        };
        ...
        this.getDataAtCol = function (col) {
            return [].concat.apply([], datamap.getRange({row: 0, col: col}, {
        ...
        this.getDataAtProp = function (prop) {
            ...
            }, {row: priv.settings.data.length - 1, col: datamap.propToCol(prop)}));
        };
